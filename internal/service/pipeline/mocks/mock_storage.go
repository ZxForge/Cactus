...
func (m *MockStorage) CreatePipelineTX(ctx context.Context, storageTx pipeline.StorageTx, arg pipeline.CreatePipelineParams) ([]dto.Pipeline, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStorageMockRecorder) CreatePipelineTX(ctx, storageTx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreatePipelineTX", reflect.TypeOf((*MockStorage)(nil).CreatePipelineTX), ctx, storageTx, arg)
}
